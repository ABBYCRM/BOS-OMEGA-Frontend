...
_Generated by `artifacts/api-server/test/lattice_round_trip.spec.mjs` on 2026-04-27T08:25:51.604Z._
...
| --- | --- |
| `format_version` | `1.0` |
| `fidelity_sha256` | `05e41d54601a3e1b3d68762724570e14f0fa4354225c41da8ef382970f80958b` |
| `byte_size` (bytes) | 50856 |
| `task_count` (tasks in export) | 3 |
| Source user | `lattice-rt-a-1777278303766@bos-omega.local` |
| Receiving session | same user, fresh `bos_session` cookie |
| Rehydration conversation id | `6855fbe1-747c-47e0-95d1-1d7d0601706f` |
...
automatic in BOS-OMEGA itself: this run's hash `05e41d54601a3e1b3d68762724570e14f0fa4354225c41da8ef382970f80958b`
