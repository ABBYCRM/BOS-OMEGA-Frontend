...
_Generated by `artifacts/api-server/test/lattice_round_trip.spec.mjs` on 2026-04-27T18:39:39.011Z._
...
| --- | --- |
| `format_version` | `1.0` |
| `fidelity_sha256` | `3c2d2d5c36b4f189e7daa8941d3891e1595f1f708f05568676191a4ef317100e` |
| `byte_size` (bytes) | 55722 |
| `task_count` (tasks in export) | 3 |
| Source user | `lattice-rt-a-1777315177187@bos-omega.local` |
| Receiving session | same user, fresh `bos_session` cookie |
| Rehydration conversation id | `(not created)` |
...
<!-- ROUND_TRIP_DEV_CAVEAT_BEGIN -->
> **Dev-env caveat (auto-detected on 2026-04-27):** the most recent
> round-trip run produced under-met audit counts:
>
> - `SCRATCHPAD_AUTO_WRITTEN`: 0 (asserted minima: 3)
> - `LLM_INPUT_PREPARED`: 0 (asserted minima: 4)
>
