...
_Generated by `artifacts/api-server/test/lattice_round_trip.spec.mjs` on 2026-04-27T21:19:26.801Z._
...
| --- | --- |
| `format_version` | `1.0` |
| `fidelity_sha256` | `3ff519a6cec89ae9c79dce63d72074fa9d4e81d0c5400946855fbcb6126f5423` |
| `byte_size` (bytes) | 68216 |
| `task_count` (tasks in export) | 3 |
| Source user | `lattice-rt-a-1777324693829@bos-omega.local` |
| Receiving session | same user, fresh `bos_session` cookie |
| Rehydration conversation id | `5c582c9e-f9b5-4dd9-abab-35ce9d8e9eab` |
...
automatic in BOS-OMEGA itself: this run's hash `3ff519a6cec89ae9c79dce63d72074fa9d4e81d0c5400946855fbcb6126f5423`
