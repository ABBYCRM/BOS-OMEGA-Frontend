...
_Generated by `artifacts/api-server/test/lattice_round_trip.spec.mjs` on 2026-04-27T22:00:37.231Z._
...
| --- | --- |
| `format_version` | `1.0` |
| `fidelity_sha256` | `3c84cf572af585ab4662fd42dbc85098c6bded3fad2cb0767187df9f399cd00c` |
| `byte_size` (bytes) | 57612 |
| `task_count` (tasks in export) | 3 |
| Source user | `lattice-rt-a-1777327235205@bos-omega.local` |
| Receiving session | same user, fresh `bos_session` cookie |
| Rehydration conversation id | `fe96a149-04a1-444f-8fa9-df3e3469266e` |
