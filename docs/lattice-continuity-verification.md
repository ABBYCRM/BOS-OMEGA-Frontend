...
_Generated by `artifacts/api-server/test/lattice_round_trip.spec.mjs` on 2026-04-27T22:06:14.314Z._
...
| --- | --- |
| `format_version` | `1.0` |
| `fidelity_sha256` | `d39c8028b81acb7de7c3d5c4079ee25603e014850cea19573cfad4f20428b9a0` |
| `byte_size` (bytes) | 57612 |
| `task_count` (tasks in export) | 3 |
| Source user | `lattice-rt-a-1777327571967@bos-omega.local` |
| Receiving session | same user, fresh `bos_session` cookie |
| Rehydration conversation id | `6404537f-da95-41dc-be38-2d205150124a` |
