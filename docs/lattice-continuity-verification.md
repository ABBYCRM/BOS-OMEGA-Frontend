...
_Generated by `artifacts/api-server/test/lattice_round_trip.spec.mjs` on 2026-04-27T21:45:18.675Z._
...
| --- | --- |
| `format_version` | `1.0` |
| `fidelity_sha256` | `147d6f4f140800addfba2ad61f7499cfb15c4706a8ee31a3eaab034549ea0be0` |
| `byte_size` (bytes) | 70626 |
| `task_count` (tasks in export) | 3 |
| Source user | `lattice-rt-a-1777326228852@bos-omega.local` |
| Receiving session | same user, fresh `bos_session` cookie |
| Rehydration conversation id | `9140ed5a-1706-4124-acad-421ca3f37e77` |
