...
_Generated by `artifacts/api-server/test/lattice_round_trip.spec.mjs` on 2026-04-27T21:57:30.674Z._
...
| --- | --- |
| `format_version` | `1.0` |
| `fidelity_sha256` | `d9e00e1f3ff7efa2f4b1363c8dbec2d7cea7a47bed514281a1b7a0cb70d900b1` |
| `byte_size` (bytes) | 57612 |
| `task_count` (tasks in export) | 3 |
| Source user | `lattice-rt-a-1777327048726@bos-omega.local` |
| Receiving session | same user, fresh `bos_session` cookie |
| Rehydration conversation id | `23eaab24-2a93-4221-87fe-7bfc2500acde` |
