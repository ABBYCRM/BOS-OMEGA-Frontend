...
export async function seed() {
  ...
  const models = [
    ...
    { id: "mdl_claude3o", provider_id: "prov_anthropic", model_name: "claude-3-opus-20240229", tags: ["reasoning", "legal", "research", "long_context", "safety"], context: 200000, cost_in: 0.015, cost_out: 0.075, rel: 0.95, lat: 0.7 },
    { id: "mdl_gemini15p", provider_id: "prov_gemini", model_name: "gemini-1.5-pro", tags: ["reasoning", "long_context", "multimodal", "research"], context: 2000000, cost_in: 0.00125, cost_out: 0.005, rel: 0.93, lat: 0.78 },
    { id: "mdl_gemini15f", provider_id: "prov_gemini", model_name: "gemini-1.5-flash", tags: ["fast", "cheap", "structured_output", "multimodal"], context: 1000000, cost_in: 0.000075, cost_out: 0.0003, rel: 0.90, lat: 0.95 },
